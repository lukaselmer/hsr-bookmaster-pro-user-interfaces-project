...
public class TextCheckerManager {
	...
	/**
	 * return a component that give visual feedback if the text component does not pass the checkers tests
	 * 
	 * @param textComp
	 ...
	 */
	public static JComponent getTextComponentWithCheckers(final JTextComponent textComp, final List<Checker<JTextComponent>> checkers,
	...
	public static JComponent getTextComponentWithCheckers(final JTextComponent textComp, final Checker<JTextComponent> checker,
			final eViewError type, final Shape shape) {
	...
	public static JComponent getTextComponentWithCheckers(final JTextComponent textComp, final Checker<JTextComponent> checker, final eViewError type) {
		return getTextComponentWithCheckers(textComp, checker, type, null);
	}

	public static JComponent getTextComponentWithCheckers(final JTextComponent textComp, final List<Checker<JTextComponent>> checkers,
			final eViewError type) {
