...
public class ErrorUI extends LockUI {
	...
	private void paintCloseButton(final Graphics2D g) {
		if (isCloseable()) {
			...
			front.transform(AffineTransform.getTranslateInstance(this.comp.getWidth() - 70, this.comp.getHeight() - 70));
			g2.fill(front);
			...
			shadow.transform(AffineTransform.getTranslateInstance(this.comp.getWidth() - 67, this.comp.getHeight() - 68));
