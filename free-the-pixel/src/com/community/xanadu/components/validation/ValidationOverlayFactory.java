...
public class ValidationOverlayFactory {
	...
	// ------------------------------------
	public static <T extends JComponent> ValidationOverlay createBlinkingAndIcon(final T comp, final List<Validator<T>> validators) {
		return createErrorOverlayedIcon(validators, comp, Color.RED, true, true);
	}

	public static <T extends JComponent> ValidationOverlay createBlinkingAndIcon(final T comp, final Validator<T> validator) {
	...
	// ------------------------------------------
	public static <T extends JComponent> ValidationOverlay createBlinking(final T comp, final List<Validator<T>> validators) {
	...
	private static <T extends JComponent> ValidationOverlay internalCreateBlinking(final T comp, final List<Validator<T>> validators) {
		return createErrorOverlayedIcon(validators, comp, Color.red, true, false);
	}

	// -------------------------------------
	public static <T extends JComponent> ValidationOverlay createErrorOverlayedIcon(final T comp, final Validator<T> validator) {
		final ArrayList<Validator<T>> validators = new ArrayList<Validator<T>>();
		validators.add(validator);
		return createErrorOverlayedIcon(validators, comp, null, false, true);
	}

	public static <T extends JComponent> ValidationOverlay createErrorOverlayedIcon(final T comp, final List<Validator<T>> validators) {
		return createErrorOverlayedIcon(validators, comp, null, false, true);
	}
	...
	private static <T extends JComponent> ValidationOverlay createErrorOverlayedIcon(final List<Validator<T>> validators,
		...
		final ValidationOverlay over = new ValidationOverlay(jxlayer, (ValidationLayer<JComponent>) layer, icon,
				ValidationPanelIcon.DEFAULT_ICON_LOCATION, ValidationPanelIcon.DEFAULT_XOFFSET, ValidationPanelIcon.DEFAULT_YOFFSET);
