...
public abstract class ValidationPaint {
	...
	public static ValidationPaint getColorValidationPaint(final Color color) {
		return new ValidationPaint() {
			@Override
			public void paint(final Graphics2D g, final List<String> msg, final JXLayer<JComponent> layer, final float animProgress) {
	 ...
	 *            height of the layer
	 * @param animProgress
	 *            goes from 0 to 1 and then from 1 to 0, the duration of the animation can be set using
	 *            ValidationOverlay.setAnimationDuration
	 */
