...
public class WindowFadeInManager {
	...
	public static void fadeIn(final Window window, final int duration) {
		final TimelineCallback tt = new TimelineCallback() {
			...
			public void onTimelineStateChanged(final Timeline.TimelineState oldState, final TimelineState newState, final float durationFraction,
	...
	public static int fadeIn(final JOptionPane optionPane, final String title, final Component parent, final int duration) {
