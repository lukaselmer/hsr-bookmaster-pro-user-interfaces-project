...
public class TitleLabel extends JComponent {
	...
	protected void paintComponent(final Graphics g) {
		...
		final SubstanceColorScheme scheme = skin.getMainActiveColorScheme(DecorationAreaType.GENERAL);
		...
		if (theTitle != null) {
			SubstanceTextUtilities.paintText(graphics, this, new Rectangle(xOffset, 0, getWidth(), getHeight()), theTitle, -1, font,
