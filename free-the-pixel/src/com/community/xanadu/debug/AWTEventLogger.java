...
public class AWTEventLogger {
	...
	public static void turnOnMouseEventDebug() {
		turnOnAWTEventDebug(AWTEvent.MOUSE_EVENT_MASK | AWTEvent.MOUSE_MOTION_EVENT_MASK | AWTEvent.MOUSE_WHEEL_EVENT_MASK);
	}
	 ...
	 *            for example AWTEvent.MOUSE_EVENT_MASK|AWTEvent.MOUSE_MOTION_EVENT_MASK
	 */
