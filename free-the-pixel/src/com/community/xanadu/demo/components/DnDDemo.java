...
import com.community.xanadu.components.dnd.DnDGhostManager;
import com.community.xanadu.components.dnd.DnDSuccessCallBack;
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				DnDSuccessCallBack cbImage = new DnDSuccessCallBack() {
					@Override
					public void dropSuccess(final DataFlavor source, final DropTargetContext context, final Transferable transfer,
