...
public class PaintUtils {
	 ...
	 *            outside color
	 */
	public static void drawHighLightText(final Graphics2D g, final int size, final float opacity, final String text, final int x, final int y,
	 ...
	 *            outside color
	 */
	public static void drawHighLightText(final Graphics2D g, final String text, final int x, final int y, final Color in, final Color out) {
	...
	public static void turnOnQualityRendering(final Graphics2D g2) {
		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
	...
	public static void drawMultiLineText(final Graphics g, final String text, final JComponent comp, final Paint paint) {
		drawMultiLineText(g, text, comp.getWidth(), true, 0, 0, paint, null);
	}

	public static void drawMultiLineText(final Graphics g, final String text, int width, final boolean hCenter, final int xOffset, final int yOffset,
	...
	public static void drawMultiLineHighLightText(final Graphics2D g, final Rectangle viewRect, final int size, final float opacity,
			final String text, final int xOffset, final int yOffset, final Color in, final Color out, final boolean hCenter, final boolean vCenter) {
		String[] splitedText;
		if (text != null && !text.isEmpty()) {
			splitedText = text.split("\n");
	...
	public static void drawMultiLineHighLightText(final Graphics2D g, final int size, final float opacity, final String text, final int xOffset,
			final int yOffset, final Color in, final Color out) {
		String[] splitedText;
		if (text != null && !text.isEmpty()) {
			splitedText = text.split("\n");
	...
	public static void drawMultiLineHighLightText(final Graphics2D g, final JComponent comp, final String text, final Color in, final Color out) {
		drawMultiLineHighLightText(g, new Rectangle(0, 0, comp.getWidth(), comp.getHeight()), 2, 0.75f, text, 0, 0, in, out, true, true);
	}
