...
/**
 * FocusTrigger handles focus events and triggers an animation based on those events. For example, to have anim start
 * when component receives an GAINED event, one might write the following:
 * 
 * <pre>
...
public class FocusTrigger extends Trigger implements FocusListener {
	 ...
	 */
	public static FocusTrigger addTrigger(final JComponent component, final Timeline timeline, final FocusTriggerEvent event) {
	 ...
	 *            the FocusTriggerEvent that will cause the action to fire
	 */
	public FocusTrigger(final Timeline timeline, final FocusTriggerEvent event) {
	 ...
	 *            flag to determine whether the timeline should stop and reverse based on opposite triggerEvents.
	 */
	public FocusTrigger(final Timeline timeline, final FocusTriggerEvent event, final boolean autoReverse) {
		super(timeline, event, autoReverse);
	}

	/**
	 * Called by the object which added this trigger as a FocusListener. This method starts the timeline if the trigger
	 * is waiting for a GAINED event.
	 */
