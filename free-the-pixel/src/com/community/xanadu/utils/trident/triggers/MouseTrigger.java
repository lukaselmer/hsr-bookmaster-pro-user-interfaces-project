...
/**
 * MouseTrigger handles mouse events and triggers an animation based on those events. For example, to have anim start
 * when component receives an ENTER event, one might write the following:
 * 
 * <pre>
...
public class MouseTrigger extends Trigger implements MouseListener {
	 ...
	 */
	public static MouseTrigger addTrigger(final JComponent component, final Timeline timeline, final MouseTriggerEvent event) {
	...
	/**
	 * Creates a non-auto-reversing MouseTrigger, which should be added to a Component that will generate the mouse
	 * events of interest
	 */
	...
	/**
	 * Called by the object which added this trigger as a MouseListener. This method starts the timeline if the trigger
	 * is waiting for an ENTER event.
	 */
	...
	/**
	 * Called by the object which added this trigger as a MouseListener. This method starts the timeline if the trigger
	 * is waiting for a RELEASE event.
	 */
