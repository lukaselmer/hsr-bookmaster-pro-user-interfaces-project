...
public abstract class AbstractMorphingButton extends JButton {
	...
	protected void paintComponent(final Graphics g) {
		...
		PaintUtils.turnOnAntialias(g2);
		if (isEnabled()) {
			painter.paintContourBackground(g2, this, getWidth(), getHeight(), this.morph, false, SubstanceLookAndFeel.getCurrentSkin()
					.getColorScheme(this, ComponentState.DEFAULT), null, morphing, true, true);
//			painter.paintContourBackground(g2, this, getWidth(), getHeight(), this.morph, false, SubstanceLookAndFeel.getCurrentSkin()
//					.getColorScheme(this, ComponentState.DEFAULT), true);

		} else {
			painter.paintContourBackground(g2, this, getWidth(), getHeight(), this.sourceShape, false, SubstanceLookAndFeel.getCurrentSkin()
					.getColorScheme(this, ComponentState.DEFAULT), null, morphing, true, true);
//			painter.paintContourBackground(g2, this, getWidth(), getHeight(), this.sourceShape, false, SubstanceLookAndFeel.getCurrentSkin()
//					.getColorScheme(this, ComponentState.DEFAULT), true);
		}
