...
public abstract class AbstractShapeButton extends JButton {
	...
	public AbstractShapeButton() {
		...
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			SubstanceColorScheme activeColor = SubstanceLookAndFeel.getCurrentSkin().getColorScheme(this, ComponentState.DEFAULT);
	...
	public void setAnimProgress(final float animProgress) {
		...
		this.currentColor = (SubstanceColorUtilities.getInterpolatedColor(this.armedColor, this.defaultColor, animProgress));
		repaint();
	}

	public void setDefaultColor(final Color defaultColor) {
		this.defaultColor = defaultColor;
		this.currentColor = (SubstanceColorUtilities.getInterpolatedColor(this.armedColor, this.defaultColor, this.animProgress));
		repaint();
	}
