	...
	protected void paintImage(final Graphics g, final float animFraction) {
		...
		if (this.shrinkImage) {
			g2.drawImage(this.originalImage, (int) (this.originalImage.getWidth() * animFraction) / 2,
					(int) (this.originalImage.getHeight() * animFraction) / 2, (int) (this.originalImage.getWidth() * i), (int) (this.originalImage
							.getHeight() * i), null);
		} else {
			g2.drawImage(this.originalImage, 0, 0, (this.originalImage.getWidth()), (this.originalImage.getHeight()), null);
		}
