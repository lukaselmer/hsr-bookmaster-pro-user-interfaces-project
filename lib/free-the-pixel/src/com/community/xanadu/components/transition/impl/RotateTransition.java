...
public class RotateTransition extends CloseTransition {
	...
	protected void paintImage(final Graphics g, final float animFraction) {
		...
		g2.drawImage(this.originalImage, (int) (this.originalImage.getWidth() * animFraction) / 2, 0, (int) (this.originalImage.getWidth() * i),
				(int) (this.originalImage.getHeight() * i), null);
		g2.dispose();
	}
}
