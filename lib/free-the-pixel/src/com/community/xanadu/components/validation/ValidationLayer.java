...
public class ValidationLayer<T extends JComponent> extends AbstractLayerUI<JComponent> {
	...
	public ValidationLayer(final T originalTrackedComp, final List<Validator<T>> checkers, final ValidationPanelIcon info) {
		super();
	...
	private void startShowAnim() {
		...
		if (this.animatorRect.getState() != TimelineState.PLAYING_FORWARD && this.animatorRect.getState() != TimelineState.PLAYING_REVERSE) {
