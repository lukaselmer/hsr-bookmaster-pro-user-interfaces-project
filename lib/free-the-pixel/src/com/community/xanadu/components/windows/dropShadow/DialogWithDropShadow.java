...
public class DialogWithDropShadow extends JDialog {
	...
	protected JComponent titleLabel;
	protected JButton buttonClose;
	protected DropShadowContentPane contentPane;
	...
	@Override
	public DropShadowContentPane getContentPane() {
			...
			return new TransitionAwareIcon(this.buttonClose, new TransitionAwareIcon.Delegate() {
				public Icon getColorSchemeIcon(final SubstanceColorScheme scheme) {
					return SubstanceIconFactory.getTitlePaneIcon(SubstanceIconFactory.IconKind.CLOSE, scheme, SubstanceCoreUtilities.getSkin(
							DialogWithDropShadow.this.rootPane).getBackgroundColorScheme(DecorationAreaType.GENERAL));
				}
