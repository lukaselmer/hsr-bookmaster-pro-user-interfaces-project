		...
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			return new TransitionAwareIcon(this.buttonMini, new TransitionAwareIcon.Delegate() {
				public Icon getColorSchemeIcon(final SubstanceColorScheme scheme) {
					return SubstanceIconFactory.getTitlePaneIcon(SubstanceIconFactory.IconKind.MINIMIZE, scheme, SubstanceCoreUtilities.getSkin(
							FrameWithDropShadow.this.rootPane).getBackgroundColorScheme(DecorationAreaType.GENERAL));
				}
	...
	private Icon getIconMax() {
		...
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			return new TransitionAwareIcon(this.buttonMax, new TransitionAwareIcon.Delegate() {
				public Icon getColorSchemeIcon(final SubstanceColorScheme scheme) {
					return SubstanceIconFactory.getTitlePaneIcon(SubstanceIconFactory.IconKind.MAXIMIZE, scheme, SubstanceCoreUtilities.getSkin(
							FrameWithDropShadow.this.rootPane).getBackgroundColorScheme(DecorationAreaType.GENERAL));
				}
	...
	private Icon getIconRestore() {
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			return new TransitionAwareIcon(this.buttonRestore, new TransitionAwareIcon.Delegate() {
				public Icon getColorSchemeIcon(final SubstanceColorScheme scheme) {
					return SubstanceIconFactory.getTitlePaneIcon(SubstanceIconFactory.IconKind.RESTORE, scheme, SubstanceCoreUtilities.getSkin(
							FrameWithDropShadow.this.rootPane).getBackgroundColorScheme(DecorationAreaType.GENERAL));
				}
	...
	private Icon getIconClose() {
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			return new TransitionAwareIcon(this.buttonClose, new TransitionAwareIcon.Delegate() {
				public Icon getColorSchemeIcon(final SubstanceColorScheme scheme) {
					return SubstanceIconFactory.getTitlePaneIcon(SubstanceIconFactory.IconKind.CLOSE, scheme, SubstanceCoreUtilities.getSkin(
							FrameWithDropShadow.this.rootPane).getBackgroundColorScheme(DecorationAreaType.GENERAL));
				}
